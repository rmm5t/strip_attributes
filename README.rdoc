...
Note: For Rails 2.x, be sure to use the <tt>~&gt; 0.9</tt> version of
strip_attributes, because strip_attributes ties directly into
ActiveRecord. Later versions (<tt>&gt; 1.0</tt>) are geared towards Rails 3 and
ActiveModel.
...
To initialize, extend <tt>StripAttributes::Shoulda::Macros</tt> in your
<tt>test_helper.rb</tt>:
...
Copyright (c) 2007-2011 Ryan McGeary released under the MIT license
